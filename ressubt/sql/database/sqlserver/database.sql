...
/*@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@*/
bulk insert dbo.contribuinte from 'C:\rst\database\data\empresa.txt'
with (
	codepage = 'ACP',
	fieldterminator = ';',  
	keepidentity
...
bulk insert dbo.produto from 'C:\rst\database\data\produto.txt'
with (
	codepage = 'ACP',
	fieldterminator=';',
	keepidentity
...
bulk insert dbo.participante from 'C:\rst\database\data\participante.txt'
with (
	codepage = 'ACP',
	fieldterminator=';',
	keepidentity
...
bulk insert dbo.movimento from 'C:\rst\database\data\movimento.txt'
with(
	codepage ='ACP',
	fieldterminator =';',
	keepidentity
...
bulk insert dbo.saldo from 'C:\rst\database\data\saldo.txt'
with(
	codepage='ACP',
	fieldterminator=';',
	keepidentity
